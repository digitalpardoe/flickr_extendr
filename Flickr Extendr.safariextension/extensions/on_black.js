...
function onBlack(settings) {
  if (settings['onBlack'] == true) {
    ...
    if (document.getElementById("button_bar")) {
      ...
      linkA    += '<a href="http://bighugelabs.com/flickr/onblack.php?id=' + pid + '" class="Plain">regular</a>, ';
      linkA    += '<a href="http://bighugelabs.com/flickr/onblack.php?id=' + pid + '&size=large" class="Plain">large</a>';
